                  ...
                  <div class="flex flex-wrap -m-2">
                    ...
                    <div class="p-2 w-full">
                      <div class="relative">
                        ...
                        <div id="gender" name="gender" class="w-full bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                         <span v-if="customer.gender == 0">男性</span>
                         <span v-else-if="customer.gender == 1">女性</span>
                         <span v-else-if="customer.gender == 2">その他</span>
  												<span v-else>{{ customer.gender }}</span>
                        </div>
                    ...
                    <div class="mt-10 p-2 w-full">
    										<button @click="deleteItem(customer.id)" class="flex mx-auto text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded text-lg">
    										削除する</button>
    									</div>
