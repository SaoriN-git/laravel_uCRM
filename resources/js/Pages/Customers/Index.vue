            ...
            <section class="text-gray-600 body-font">
              <div class="container px-5 py-5 mx-auto">
                ...
                <div class="flex pl-4 my-4 lg:w-2/3 w-full mx-auto">
                  <div>
                    <input type="text" name="search" v-model="search" class="w-38 h-10 rounded">
                    <button class="ml-1 bg-blue-400 text-white py-2 px-2 rounded" @click="searchCustomers">検索</button>
                  </div>
